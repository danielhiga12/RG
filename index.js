const { Client,const { Client, GatewayIntentBits, EmbedBuilder } = require("discord.js");
const fs = require("fs");
...
client.login(process.env.TOKEN); GatewayIntentBits, EmbedBuilder } = require("discord.js");
const fs = require("fs");
